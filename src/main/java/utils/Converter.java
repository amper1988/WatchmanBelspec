...
public class Converter {
    ...
    public static CarDataForLists convertCarDataShortToCarDataForLists(CarDataShort carDataShort, int index) throws ParseException{
        if(carDataShort!=null){
            ...
            carDataForLists.setDebtActNumber(carDataShort.getDebtActNumber());
            ...
            carDataForLists.setReleaseDate(carDataShort.getReleaseDate());
            carDataForLists.setStatus(carDataShort.getStatus());
